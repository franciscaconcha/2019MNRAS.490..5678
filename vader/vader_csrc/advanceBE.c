...
advanceBE(const double t, const double dt, const grid *grd, 
  ...
  if (eos_func == 1) {
    ...
    user_start_t = clock();
#endif
    userEOS(t, grd, col, pres, eInt, params,
  ...
  if (alpha_func == 1) {
    ...
    user_start_t = clock();
#endif
    userAlpha(t, grd, col, pres, eInt, w->gammaLast, w->deltaLast, 
	      params, w->alpha_g+1);
#ifdef TESTING_MODE
    user_end_t = clock();
    *userTime += (double) (user_end_t - user_start_t) 
  ...
  if (ibc_func == 1) {
    ...
    user_start_t = clock();
#endif
    userIBC(t, grd, col, pres, eInt, w->gammaLast, w->deltaLast, 
  ...
  if (obc_func == 1) {
    ...
    user_start_t = clock();
#endif
    userOBC(t, grd, col, pres, eInt, w->gammaLast, w->deltaLast, 
  ...
  for (*itCount = 1, converged = 0; 1; (*itCount)++) {
    ...
    if (eos_func == 1) {
      ...
      user_start_t = clock();
#endif
      userEOS(t+dt, grd, w->colNew, w->presNew_g+1, 
    ...
    if (alpha_func == 1) {
      ...
      user_start_t = clock();
#endif
      userAlpha(t+dt, grd, w->colNew, w->presNew_g+1, 
    ...
    if (ibc_func == 1) {
      ...
      user_start_t = clock();
#endif
      userIBC(t+dt, grd, w->colNew, w->presNew_g+1, 
    ...
    if (obc_func == 1) {
      ...
      user_start_t = clock();
#endif
      userOBC(t+dt, grd, w->colNew, w->presNew_g+1, 
	      w->eIntNew, w->gammaNew, w->deltaNew, 
	      obc_pres, obc_enth, params, 
	      &obc_pres_val1, &obc_enth_val1);
#ifdef TESTING_MODE
    ...
    if (intEnSrc_func == 1) {
      ...
      user_start_t = clock();
#endif
      userIntEnSrc(t+dt, grd, w->colNew, w->presNew_g+1, 
    ...
    if (massSrc_func == 1) {
      ...
      user_start_t = clock();
#endif
      userMassSrc(t+dt, grd, w->colNew, w->presNew_g+1, 
		  w->eIntNew, w->gammaNew, 
